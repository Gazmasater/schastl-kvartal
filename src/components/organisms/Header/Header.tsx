...
export const Header: FC = () => {
  return (
    <Styled.Header $isNavOpen={false} className="header">
      <Styled.Container>
        <Styled.Logo>
          <Styled.LogoLink title="Главная страница" href="/">
            <Styled.Image src="/img/logo-default.svg" width="113" height="128" alt="Логотип" draggable="false" />
          </Styled.LogoLink>
        </Styled.Logo>
        <Styled.MiddleContainer>
          <div>
            <Styled.MobPhone>
              ...
              <Styled.PhoneText>+7 1112223344</Styled.PhoneText>
        ...
        <Styled.LinksRight>
          <Styled.LinksRightContainer className="MuiGrid-root jss35 jss40 jss109 MuiGrid-container MuiGrid-wrap-xs-nowrap">
        ...
        <Styled.CustomButton type="button">
