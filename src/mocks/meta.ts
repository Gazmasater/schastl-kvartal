...
export const Metas: TMetas = {
  homepage: {
    ...
    description:
      'Купить готовый дом с участком в коттеджном посёлке «Счастливый Квартал»: с. Ленино, Липецкий район, 6 км от Липецка.',
  },
  housesInLipetskDistrict: {
    title: 'Купить дом в Липецком районе — КП «Счастливый Квартал»',
    description:
      'Проекты домов с участками в коттеджном посёлке «Счастливый Квартал» в селе Ленино Липецкого района, в 6 км от Липецка.',
  },
