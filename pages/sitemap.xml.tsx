...
const urls = [
  ...
  '/stati',
  '/stati/tseny-na-gotovye-doma-v-lipetskom-rayone',
  '/stati/gotovyj-dom-s-uchastkom-v-lipetskom-rajone',
  ...
  '/stati/konnyj-klub-v-lenino',
  '/stati/gorki-i-tyubing-ryadom-s-lenino',
  '/stati/infrastruktura-romanovo-city-v-lenino',
